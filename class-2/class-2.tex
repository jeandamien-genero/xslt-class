...
<xsl:template match="//body/p">
    ...
    \begin{frame}{XSLT/ Principales règles (4/4) : \texttt{<xsl:apply-template/>}}
         \Large
         \begin{itemize}
             \item \texttt{<xsl:apply-template/>} est une \textbf{instruction récursive} : le processeur va \textbf{examiner les n\oe uds enfants} dans l’ordre et \textbf{appliquer les règles} qui leur sont associées.
