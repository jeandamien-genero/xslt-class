...
\begin{document}
  ...
  \begin{frame}[fragile]{XSLT/ Ordre d'application des règles}
    \Large
        \begin{itemize}
            \item L'ordre d'écriture des règles n'a aucune importance pour le processeur XSLT ;
    ...
    <xsl:element name="body">
     ...
     \begin{frame}{XSLT/ Principales règles (1/4) : \texttt{<xsl:apply-template/>}}
         ...
         \begin{itemize}
             ...
             \item \texttt{<xsl:apply-template/>} est une \textbf{instruction récursive} : le processeur va \textbf{examiner les n\oe uds enfants} dans l’ordre et a\textbf{ppliquer les règles} qui leur sont associées.
            \bigskip
