...
\end{frame}
   ...
   \end{frame}
    ...
    \Large
        \begin{itemize}
            \item Premier élément de l'arbre (n\oe ud racine) $\rightarrow$ \textbf{/} \textit{(attention : ce n'est pas forcément l'élément racine \texttt{<TEI>})}
            \item \texttt{decendant::} $\rightarrow$ \textbf{//}
